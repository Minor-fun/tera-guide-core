		...
		switch (section) {
			...
			case "index":
				...
				if (onlineTTS) {
					...
					tmpData.push(
						...
						{ "text": `<font color="${onlineTTSConfig.enabled ? gcg : gcr}" size="+18">[Enable/Disable]</font>`, "command": `${cmd} onlinetts;${cmd} gui` },
						{ "text": onlineTTSConfig.enabled ? `&nbsp;&nbsp;<font color="${gcb}" size="+18">[Test]</font>` : "", "command": onlineTTSConfig.enabled ? `${cmd} onlinetts test;${cmd} gui` : "" },
						{ "text": "<br>" }
					);
					...
					if (onlineTTSConfig.enabled) {
						...
						tmpData.push(
							...
							{ "text": `<font color="${gcb}" size="+18">[Change]</font>`, "command": `${cmd} admin show onlinetts-voices` }, 
							{ "text": "<br>" },
			...
			case "onlinetts-voices":
				...
				if (onlineTTS && onlineTTSConfig) {
					// 标题和当前默认语音
					tmpData.push(
						{ "text": `<font color="${gcy}" size="+20">Online TTS Voice Settings</font>` }, { "text": "<br><br>" },
						...
						{ "text": `<font color="${gcy}" size="+18">Add/Modify Voice:</font>` }, { "text": "<br>" },
						{ "text": `<font color="${gcgr}" size="+16">Use Command: ${cmd} onlinetts addvoice &lt;Voice Name&gt; &lt;Voice ID&gt;</font>` }, { "text": "<br><br>" },
						{ "text": `<font color="${gcy}" size="+18">Available Voices:</font>` }, { "text": "<br>" }
					);
					...
					Object.keys(onlineTTS.getVoices()).forEach(voiceName => {
						...
						tmpData.push(
							{ "text": "&nbsp;&nbsp;&nbsp;&nbsp;" },
							{ "text": `<font color="${isDefault ? gcg : gcr}" size="+18">[Select]</font>`, "command": `${cmd} onlinetts voice ${voiceName};${cmd} admin show onlinetts-voices` }, { "text": "&nbsp;&nbsp;" },
							{ "text": `<font color="${isDefault ? gcr : gcb}" size="+18">[Delete]</font>`, "command": `${cmd} onlinetts deletevoice ${voiceName};${cmd} admin show onlinetts-voices` }, { "text": "&nbsp;&nbsp;" },
					...
					// 在线TTS未初始化
					tmpData.push(
						{ "text": `<font color="${gcr}" size="+20">Online TTS System Not Initialized</font>` }, { "text": "<br><br>" },
						{ "text": `<font color="${gcb}" size="+18">[Return to Main Menu]</font>`, "command": `${cmd} admin show index` }
					);
				}
				break;
