		...
		switch (section) {
			...
			case "index":
				...
				if (onlineTTS) {
					...
					// Online TTS switch
					tmpData.push(
						{ "text": `<font color="${gcy}" size="+20">Online TTS:</font>` }, { "text": "&#09;&#09;" },
						{ "text": `<font color="${onlineTTSConfig.enabled ? gcg : gcr}" size="+18">[Enable/Disable]</font>`, "command": `${cmd} onlinetts;${cmd} gui` }, { "text": "&nbsp;&nbsp;" }
					);
					
					// If online TTS is enabled, show more options
					if (onlineTTSConfig.enabled) {
						// Online TTS test button
						tmpData.push(
							{ "text": `<font color="${gcb}" size="+18">[Test]</font>`, "command": `${cmd} onlinetts test;${cmd} gui` }, { "text": "<br>" }
						);
						
						// Online TTS voice settings
						tmpData.push(
							{ "text": `<font color="${gcy}" size="+20">Online TTS Voice:</font>` }, { "text": "&#09;" }
						);
						
						// Show current default voice and button to switch to voice settings page
						tmpData.push(
							{ "text": `<font color="${gcgr}" size="+18">Current: ${onlineTTSConfig.defaultVoice}</font>` }, { "text": "&nbsp;&nbsp;" },
							{ "text": `<font color="${gcb}" size="+18">[Change]</font>`, "command": `${cmd} admin show onlinetts-voices` }, { "text": "<br>" }
						);
						
						// Online TTS rate settings
						tmpData.push(
							{ "text": `<font color="${gcy}" size="+20">Online TTS Rate:</font>` }, { "text": "&#09;" }
						);
						
						// Show rate options
						const rateOptions = [0.5, 0.75, 1, 1.25, 1.5, 1.75, 2, 3, 4, 5];
						...
						// If API key is not set, show prompt to set API key
						tmpData.push(
							{ "text": "<br>" },
							{ "text": `<font color="${gcr}" size="+18">API key not set, please use command: ${cmd} onlinetts apikey YOUR_KEY</font>` },
							{ "text": "<br>" }
						);
					}
			...
			case "onlinetts-voices":
				...
				if (onlineTTS && onlineTTSConfig) {
					// Title
					tmpData.push(
						{ "text": `<font color="${gcy}" size="+20">Online TTS Voice Settings</font>` },
						{ "text": "<br><br>" }
					);
					
					// Current default voice
					tmpData.push(
						{ "text": `<font color="${gcy}" size="+18">Current default voice: </font>` },
						{ "text": `<font color="${gcg}" size="+18">${onlineTTSConfig.defaultVoice}</font>` },
						{ "text": "<br><br>" }
					);
					
					// Add new voice instructions
					tmpData.push(
						{ "text": `<font color="${gcy}" size="+18">Add/modify voice:</font>` },
						{ "text": "<br>" },
						{ "text": `<font color="${gcgr}" size="+16">Use command: ${cmd} onlinetts addvoice &lt;voice name&gt; &lt;voice ID&gt;</font>` },
						{ "text": "<br><br>" }
					);
					
					// Available voices list
					tmpData.push(
						{ "text": `<font color="${gcy}" size="+18">Available voices:</font>` },
						{ "text": "<br>" }
					);
					...
					Object.keys(voices).forEach(voiceName => {
						tmpData.push(
							{ "text": "&nbsp;&nbsp;&nbsp;&nbsp;" },
							{ "text": `<font color="${onlineTTSConfig.defaultVoice === voiceName ? gcg : gcr}" size="+18">[Select]</font>`, "command": `${cmd} onlinetts voice ${voiceName};${cmd} admin show onlinetts-voices` }, { "text": "&nbsp;&nbsp;" },
							{ "text": `<font color="${onlineTTSConfig.defaultVoice === voiceName ? gcr : gcb}" size="+18">[Delete]</font>`, "command": `${cmd} onlinetts deletevoice ${voiceName};${cmd} admin show onlinetts-voices` }, { "text": "&nbsp;&nbsp;" },
							{ "text": `<font color="${gcgr}" size="+18">${voiceName}: ${voices[voiceName]}</font>` },
							{ "text": "<br>" }
						);
					});
					...
					tmpData.push(
						{ "text": "<br>" },
						{ "text": `<font color="${gcb}" size="+18">[Return to Main Menu]</font>`, "command": `${cmd} admin show index` },
						{ "text": "<br>" }
					);
				} else {
					// Online TTS not initialized
					tmpData.push(
						{ "text": `<font color="${gcr}" size="+20">Online TTS system not initialized</font>` },
						{ "text": "<br><br>" },
						{ "text": `<font color="${gcb}" size="+18">[Return to Main Menu]</font>`, "command": `${cmd} admin show index` }
					);
				}
