				...
				if (onlineTTS) {
					...
					if (onlineTTSConfig.enabled) {
						...
						tmpData.push(
							...
							{ "text": `<font color="${gcgr}" size="+18">${str.onlineTTSCurrentVoice}${onlineTTSConfig.defaultVoice}</font>` }, { "text": "&nbsp;&nbsp;" },
			...
			case "onlinetts-voices":
				...
				if (onlineTTS && onlineTTSConfig) {
					...
					tmpData.push(
						...
						{ "text": `<font color="${gcg}" size="+18">${onlineTTSConfig.defaultVoice}</font>` }, { "text": "<br><br>" },
					...
					Object.keys(onlineTTS.getVoices()).forEach(voiceName => {
						...
						tmpData.push(
							...
							{ "text": `<font color="${gcgr}" size="+18">${voiceName}: ${onlineTTS.getVoices()[voiceName]}</font>` }, { "text": "<br>" }
						);
					});
