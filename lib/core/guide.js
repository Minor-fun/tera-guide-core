...
class Guide extends EventEmitter {
	...
	load(debugMode = false) {
		...
		if (typeof object === "function") {
			...
			let t = null;
			if (this.__deps.mod.i18nManager) {
				try {
					t = this.__deps.mod.i18nManager.createTranslator(this.__id, this.__deps.lang.language);
				} catch (e) {
					// ignore
				}
			}

			this.__context = object(this.__deps.dispatch, this.__deps.handlers.types, guideObject(this), this.__deps.lang.props, t);
		} else {
